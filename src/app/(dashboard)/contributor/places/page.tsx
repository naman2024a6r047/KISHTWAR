...
import ContributorPlacesTable from "./ContributorPlacesTable";
...
export default async function ContributorPlacesPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        <div>
          <h1 className="text-2xl sm:text-3xl font-serif font-bold text-kishtwar-green-950">
            My Tourist Places & Destinations
          </h1>
      ...
      {/* Places Table */}
      <ContributorPlacesTable initialPlaces={places} />
    </div>
  );
}
