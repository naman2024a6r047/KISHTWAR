...
import ContributorBlogsTable from "./ContributorBlogsTable";
...
export default async function ContributorBlogsPage() {
  // Enforce contributor role
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {/* Blogs Table */}
      <ContributorBlogsTable initialBlogs={blogs} />
    </div>
  );
}
