import { getBlogs, getBlogCategories } from "@/actions/blogs.actions";
...
export const metadata: Metadata = {
  title: "Travel Blogs, Stories & Heritage Guides | Kishtwar Tourism",
  description:
    "Read interesting travel stories, historical archives, cultural descriptions, and hiking guides written by contributors and locals from Kishtwar.",
  openGraph: {
    title: "Travel Blogs, Stories & Heritage Guides | Kishtwar Tourism",
    description:
      "Read interesting travel stories, historical archives, cultural descriptions, and hiking guides written by contributors and locals from Kishtwar.",
      ...
      <section className="relative bg-kishtwar-green-900 text-white overflow-hidden py-16 sm:py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-serif font-bold tracking-tight">
            Kishtwar <span className="text-gradient-gold">Chronicles & Guides</span>
          </h1>
          <p className="max-w-2xl mx-auto text-sm sm:text-base text-gray-300 leading-relaxed font-light font-sans">
            Immerse yourself in authentic narratives, cultural history, culinary tours, and hiking journals written by adventurers who know Kishtwar best.
          </p>
        </div>
      </section>
        ...
        {blogs.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl border border-kishtwar-cream-200 p-12 text-center max-w-xl mx-auto space-y-4">
            ...
            <p className="text-sm text-gray-600 leading-relaxed font-light">
              We couldn&apos;t find any articles matching your search query or filters. Try adjusting your keyword or clearing filters.
            </p>
            <Link
              href="/blog"
